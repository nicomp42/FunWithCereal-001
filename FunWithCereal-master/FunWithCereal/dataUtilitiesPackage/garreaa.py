...
# Brief Description of what this module does: This module runs a function that prints an interesting fact about the cereal data.
# Citations: Joseph Rainford
# Anything else that's relevant: 

#to fix mac virtual desktop issue, Bill put the readCSV function in here to get it to work
#from csvUtilities import *
import csv
